...
public class Game
    ...
    private List<IGamePluginService> pluginsProcessor = new ArrayList<>();
    ...
    @Override
    public void create() {
        // Next two lines are for spring annotation
    ...
    private Collection<? extends IGamePluginService> getPluginServices() {
        ...
        System.out.println("Length " + plugins.values());
        pluginsProcessor.addAll(plugins.values());
        pluginsProcessor.addAll(SPILocator.locateAll(IGamePluginService.class));
